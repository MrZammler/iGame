...
##########################################################################
src/iGameStrings_cat.c src/iGameStrings_cat.h: src/iGameStrings.cd src/C_c.sd src/C_h.sd
...
src/funcs_030.o: src/funcs.c src/iGameStrings_cat.h
	$(CC) $(CFLAGS_030) $(INCLUDES) -o $@ src/funcs.c

src/iGameGUI_030.o: src/iGameGUI.c src/iGameGUI.h src/iGameStrings_cat.h
...
src/funcs_040.o: src/funcs.c src/iGameStrings_cat.h
	$(CC) $(CFLAGS_040) $(INCLUDES) -o $@ src/funcs.c

src/iGameGUI_040.o: src/iGameGUI.c src/iGameGUI.h src/iGameStrings_cat.h
...
src/funcs_060.o: src/funcs.c src/iGameStrings_cat.h
	$(CC) $(CFLAGS_060) $(INCLUDES) -o $@ src/funcs.c

src/iGameGUI_060.o: src/iGameGUI.c src/iGameGUI.h src/iGameStrings_cat.h
...
src/funcs_MOS.o: src/funcs.c src/iGameStrings_cat.h
	$(CC) $(CFLAGS_MOS) $(INCLUDES) -o $@ src/funcs.c

src/iGameGUI_MOS.o: src/iGameGUI.c src/iGameGUI.h src/iGameStrings_cat.h
...
src/funcs_AOS4.o: src/funcs.c src/iGameStrings_cat.h
	$(CC) $(CFLAGS_AOS4) -o $@ src/funcs.c

src/iGameGUI_AOS4.o: src/iGameGUI.c src/iGameGUI.h src/iGameStrings_cat.h
