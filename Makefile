...
CFLAGS     = -c +aos68k -dontwarn=-1 -O2 -c99 -I/opt/vbcc/includes_and_libs/MUI/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_Guigfx/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_TextEditor/Developer/C/include/ -I/opt/vbcc/includes_and_libs/NDK_3.9/Include/include_h

CFLAGS_030     = -c +aos68k -cpu=68030 -dontwarn=-1 -O2 -c99 -I/opt/vbcc/includes_and_libs/MUI/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_Guigfx/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_TextEditor/Developer/C/include/ -I/opt/vbcc/includes_and_libs/NDK_3.9/Include/include_h

CFLAGS_060     = -c +aos68k -cpu=68060 -fpu=68882 -dontwarn=-1 -O2 -c99 -I/opt/vbcc/includes_and_libs/MUI/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_Guigfx/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_TextEditor/Developer/C/include/ -I/opt/vbcc/includes_and_libs/NDK_3.9/Include/include_h

CFLAGS_MOS     = -c +morphos -dontwarn=-1 -O2 -c99 -I/opt/vbcc/includes_and_libs/MUI/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_Guigfx/Developer/C/Include -I/opt/vbcc/includes_and_libs/MCC_TextEditor/Developer/C/include/ -I/opt/vbcc/includes_and_libs/NDK_3.9/Include/include_h
...
clean:
	rm iGame iGame.030 iGame.060 src/funcs*.o src/iGameGUI*.o src/iGameMain*.o src/strdup*.o
