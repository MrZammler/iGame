...
#
# $Id: cd2po.sh 268 2014-02-28 18:58:31Z damato $
#
...
BEGIN {
  ...
  print "# $Id: cd2po.sh 268 2014-02-28 18:58:31Z damato $"
  print "#"
...
}
{
  if(firsttag == 0)
  {
    ...
    {
      revision=$4 # get revision out of $Id: cd2po.sh 268 2014-02-28 18:58:31Z damato $ SVN keyword
      next
    }
    else if($0 ~ /^## language .*/)
    {
